INSERT INTO users (
    id, name, email, mobile, password, role, is_active, created_at, updated_at
) VALUES
    (1, 'Admin User', 'admin@pharmacy.local', '9000000001', '$2a$10$k5zrwq7MHMc.k74mghCNpOhOzOb2MZLje8mVp4sxE7erREHPULEaC', 'ADMIN', true, '2026-03-20 09:00:00', '2026-03-20 09:00:00'),
    (2, 'Aarav Sharma', 'customer1@pharmacy.local', '9000000002', '$2a$10$k5zrwq7MHMc.k74mghCNpOhOzOb2MZLje8mVp4sxE7erREHPULEaC', 'CUSTOMER', true, '2026-03-20 09:05:00', '2026-03-20 09:05:00'),
    (3, 'Diya Verma', 'customer2@pharmacy.local', '9000000003', '$2a$10$k5zrwq7MHMc.k74mghCNpOhOzOb2MZLje8mVp4sxE7erREHPULEaC', 'CUSTOMER', true, '2026-03-20 09:10:00', '2026-03-20 09:10:00')
